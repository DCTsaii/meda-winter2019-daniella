...
// Setting "none" for color option means you don't want any color. In the terminal command, you write none.
// Sanitize -- This is an example of BLACKLIST.
if(terminalText[3] == undefined || terminalText[3] == "none"){
    ...
    // None default color is transparent. Which means you don't want any color
    terminalText[3] == "transparent";
}

// Sanitize -- Example of a WHITELIST
