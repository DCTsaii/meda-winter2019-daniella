...
// This IF statement is to check if you picked a color from terminal, if not then this code will run.
...
// in the IF statement write the variable in this case is htmlFileName and then add == "", the double equals is to compare.
